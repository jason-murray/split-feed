...
const processMessages = function (event) {
    ...
    // ws keepalive check
    clearInterval(wsAliveInt);
    wsAliveInt = setInterval(() => {
        console.log('Keepalive failed, reconnecting ws...');
        i = 0;
        ws[i] = new WebSocket('wss://eventsub.wss.twitch.tv/ws?keepalive_timeout_seconds=10');
...
<template>
    ...
    <button @click="toggleAudio"
        class="svg bg-purple-700 hover:bg-purple-800 text-white font-bold p-2 rounded-full absolute z-40 right-[55px] top-[10px] drop-shadow-lg">
        <svg v-if="sound" height="30px" width="30px" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg v-else height="30px" width="30px" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
            <rect fill="none" height="256" width="256" />
    ...
    <button @click="goFullscreen"
        class="svg bg-purple-700 hover:bg-purple-800 text-white font-bold rounded-full absolute top-[10px] right-[2px] p-2 cursor-pointer z-40">
        <svg v-if="fullscreen" xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 16 16"
            fill="none">
            <g clip-path="url(#clip0_1450_2221)">
                <path d="M5.5 1.49909L4.19671 2.8L1.41658 0L0 1.41657L2.80003 4.2L1.5 5.5L2 6H6L6 2L5.5 1.49909Z" />
                <path
                    d="M14.5009 5.5L13.2 4.19671L16 1.41658L14.5834 0L11.8 2.80003L10.5 1.5L10 2V6L14 6L14.5009 5.5Z" />
                <path
                    d="M2.8 11.8033L1.49909 10.5L2 10L6 10L6 14L5.5 14.5L4.2 13.2L1.41657 16L0 14.5834L2.8 11.8033Z" />
                <path
                    d="M10.5 14.5009L11.8033 13.2L14.5834 16L16 14.5834L13.2 11.8L14.5 10.5L14 10H10L10 14L10.5 14.5009Z" />
            </g>
            <defs>
                <clipPath id="clip0_1450_2221">
                    <rect width="16" height="16" />
                </clipPath>
            </defs>
        </svg>
        <svg v-else height="30px" width="30px" version="1.1" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg"
            xmlns:sketch="http://www.bohemiancoding.com/sketch/ns" xmlns:xlink="http://www.w3.org/1999/xlink">
            <title />
            <desc />
            <defs />
            <g fill="none" fill-rule="evenodd" id="Page-1" stroke="none" stroke-width="1">
                <g fill="#FFFFFF" id="Core" transform="translate(-215.000000, -257.000000)">
    ...
    <div class="notifications h-full flex flex-col justify-end">
        <TransitionGroup name="notification" tag="div">
            <div v-for="notification in notifications" :key="notification.id" :class="'border' + notification.color"
